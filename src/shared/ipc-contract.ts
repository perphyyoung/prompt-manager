...
export interface IpcApi {
  ...
  getImagesPaginated: (
    options: import("./domain/database-types.js").GetImagesPaginatedOptions,
  ) => Promise<{ items: IImage[]; totalCount: number }>;
  getImageIdsByFilter: (
    options: Omit<
      import("./domain/database-types.js").GetImagesPaginatedOptions,
      "limit" | "offset"
    >,
  ) => Promise<string[]>;
  countImageTags: (
    options: import("./domain/database-types.js").CountImageTagsOptions,
  ) => Promise<Record<string, number>>;
  countImageSpecialTags: (
    options: import("./domain/database-types.js").CountImageTagsOptions,
  ) => Promise<import("./domain/database-types.js").ImageSpecialTagCounts>;
  ...
  getPromptsPaginated: (
    options: import("./domain/database-types.js").GetPromptsPaginatedOptions,
  ) => Promise<{ items: IPrompt[]; totalCount: number }>;
  getPromptIdsByFilter: (
    options: Omit<
      import("./domain/database-types.js").GetPromptsPaginatedOptions,
      "limit" | "offset"
    >,
  ) => Promise<string[]>;
  countPromptTags: (
    options: import("./domain/database-types.js").CountPromptTagsOptions,
  ) => Promise<Record<string, number>>;
  countPromptSpecialTags: (
    options: import("./domain/database-types.js").CountPromptTagsOptions,
  ) => Promise<import("./domain/database-types.js").PromptSpecialTagCounts>;
  /**
   * 创建提示词: title 缺省时主进程以 id 兜底; isDeleted 由主进程决定
   */
  addPrompt: (
    prompt: { content: string } & Partial<Omit<IPrompt, "id" | "isDeleted" | "content">>,
