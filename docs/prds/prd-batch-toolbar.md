...
| ESC 退出 | 按下 ESC 键 | 工具栏显示 | 清空选中集，工具栏隐藏，移除 selection-mode，清除所有复选框选中状态 | 选中数=0，工具栏隐藏，复选框未选中 |
| 取消按钮退出 | 点击取消按钮 | 至少选中 1 项 | 清空选中集，工具栏隐藏，移除 selection-mode，清除所有复选框选中状态 | 选中数=0，工具栏隐藏，复选框未选中 |
...
| 清空选择 | 点击取消按钮/ESC | 至少选中 1 项 | 清空选中集，清除所有复选框选中状态 | 选中数=0，工具栏隐藏，selection-mode 移除，复选框未选中 |
