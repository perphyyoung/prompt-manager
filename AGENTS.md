...
This project is indexed by GitNexus as **prompt-manager** (2580 symbols, 8700 relationships, 221 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
