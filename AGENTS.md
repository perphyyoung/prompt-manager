...
This project is indexed by GitNexus as **prompt-manager** (3730 symbols, 13377 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
