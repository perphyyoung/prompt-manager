---
name: writing-plans
description: 当你有规格说明, 或需求用于多步骤任务时使用，在动手写代码之前
---
...
**上下文：** 此技能应在 由 brainstorming 技能创建的上下文中运行。
...
> **面向 AI 代理的工作者：** 如果任务可以并行, 使用最多 3 个 subagent 逐任务实现此计划。步骤使用复选框（`- [ ]`）语法来跟踪进度。
...
**"计划已完成并保存到 `docs/superpowers/plans/<filename>.md`。请确认是否按计划执行**
